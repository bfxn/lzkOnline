...
# 新建了base.html页面，让org_list继承base页面
# 主路由urls中org_list
# 然后models中添加机构类型字段，添加机构时要上传图片，在settings中配置上传文件的路径
# 在image字段中设置upload_to=“”，拼接出一个完整的路径，“/media/org/2020/月份/图片名字”
...
class TeacherDetailView(View):
    ...
    def get(self,request,teacher_id):
        ...
        if UserFavorite.objects.filter(user=request.user,fav_type=2,fav_id=teacher.org.id).exists():
            has_org_faved = True
